<ul class="app-menu">
    ...
    @endcanany
    @canany(['students.create', 'students.edit', 'students.read', 'students.delete', 'students.show', 'students.create',
        'studentss.create.rajab', 'students.create.commission', 'students.create.evaluation', 'students.read.rajab',
        'students.read.commission', 'students.read.evaluation'])
        <li class="treeview {{ Settings::check_parent_route(['students.', 'admin.student.']) }}">
            ...
            <ul class="treeview-menu">
                @canany(['students.create', 'students.create.rajab', 'students.create.commission',
                    'students.create.evaluation'])
                    <li>
                ...
                @canany(['students.read.evaluation', 'students.import', 'students.read'])
                    <li>
                        <a class="app-menu__item {{ Settings::current_route('admin.student.form.evaluation') }}"
                            href="{{ route('admin.student.form.evaluation') }}"><i
                                class="app-menu__icon bi bi-person-workspace">
                            </i>
                ...
                @canany(['students.read.rajab', 'students.import', 'students.read'])
                    <li>
                        <a class="app-menu__item {{ Settings::current_route('admin.student.form.rajab') }}"
                            href="{{ route('admin.student.form.rajab') }}"><i
                                class="app-menu__icon bi bi-person-square"></i><span
    ...
    @canany(['form.rajab.*', 'form.rajab.create', 'form.rajab.edit', 'form.rajab.read', 'form.rajab.show',
        'form.rajab.add student', 'form.commission.*', 'form.commission.create', 'form.commission.edit',
        'form.commission.read', 'form.commission.show', 'form.commission.add student', 'form.evaluation.*',
        'form.evaluation.create', 'form.evaluation.edit', 'form.evaluation.read', 'form.evaluation.show',
        'form.evaluation.add student'])
        <li class="treeview {{ Settings::check_parent_route(['admin.forms.']) }}">
            ...
            <ul class="treeview-menu">
                ...
                @endcanany
                @canany(['form.commission.*', 'form.commission.create', 'form.commission.edit', 'form.commission.read',
                    'form.commission.show', 'form.commission.add student'])
                    <li>
                ...
                @endcanany
                @canany(['form.evaluation.*', 'form.evaluation.create', 'form.evaluation.edit', 'form.evaluation.read',
                    'form.evaluation.show', 'form.evaluation.add student'])
                    <li>
    ...
    @canany(['countries.create', 'countries.edit', 'countries.read', 'countries.delete', 'countries.show',
        'categories.create', 'categories.edit', 'categories.read', 'categories.delete', 'categories.show'])
        <li class="treeview {{ Str::contains(url()->current(), 'settings') ? 'is-expanded' : '' }}"><a
            ...
            <ul class="treeview-menu">
                ...
                @endcanany
                @canany(['appreciations.create', 'appreciations.edit', 'appreciations.read', 'appreciations.delete',
                    'appreciations.show'])
                    <li>
                ...
                @endcanany
                @canany(['committee_member.create', 'committee_member.edit', 'committee_member.read',
                    'committee_member.delete', 'committee_member.show'])
                    <li>
                ...
                @endcanany
                @canany(['school_grade.create', 'school_grade.edit', 'school_grade.read', 'school_grade.delete',
                    'school_grade.show'])
                    <li>
                ...
                @endcanany
                @canany(['education_level.create', 'education_level.edit', 'education_level.read', 'education_level.delete',
                ...
                @canany(['exam_centers.create', 'exam_centers.edit', 'exam_centers.read', 'exam_centers.delete',
                    'exam_centers.show'])
                    <li>
