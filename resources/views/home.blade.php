...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="bg-white p-2 mb-3" id="pieChart" style="height: 460px;"></div>
    </div>
    <div class="col-lg-6">
        <div class="bg-white p-2 mb-3" id="barChart" style="height: 460px;"></div>
    </div>
</div>
