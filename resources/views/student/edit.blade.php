                ...
                <form action="{{route('students.update',$student)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <x-input col="col-6 col-md-4 col-lg-3 col-xl-2" name="grand_father_name"
                            :label="__('lang.grand_father_name')" :required="1"  value="{{$student->grand_father_name}}"/>
                        ...
                        <x-select col="col-6 col-md-4 col-lg-3 col-xl-2" :options="$appreciations"
                            name="appreciation_id" :label="__('lang.appreciation')" :required="1"  :selected="$student->appreciation_id"/>
