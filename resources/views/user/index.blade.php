                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" dir="ltr">
                                    ...
                                    <button class="btn btn-info btn-sm give-permission" role-id="{{ $role->id }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input user_status_toggle" type="checkbox" role="switch"
                                            id="user_status" data-id="{{ $user->id }}" @if ($user->isActive) checked
                                        @endif>
