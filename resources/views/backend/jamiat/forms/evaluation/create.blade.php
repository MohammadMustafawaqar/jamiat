    ...
    @foreach ($form as $frm)
        <div class="container-fluid borders pt-3">
            <div class="row border-bottom border-1 p-2">
                ...
                <div class="col-6">
                    <div class="text-center">
                        ...
                        <p style="margin: 0.4">د دیني جامعاتو او تخصصاتو عموميریاست</p>
                        <p style="margin: 1; white-space: nowrap; text-overflow: visible;">
                            د {{ $frm->addressType->name }} د دیني جامعاتو د {{ $frm->grade->localized_name }} دورې ({{ $frm->grade->equivalent }}) د اسنادو ارزونې فورمه
                        </p>
                    </div>
                </div>
                <div class="col-2">
            ...
            <div class="row mt-3">
                ...
                <div class="col-12">
                    <div class="mb-1">
                        اصلي استوګنځی: ولایت . . . . . . . . . . . . . . . . . . . . ولسوالي / ناحیه . . . . . . . . . .
                        . . . . . . . . . کلی / کوڅه . . . . . . . . . . . . . . . . .
                    </div>
                    <div class="mb-1">
                        فعلي استوګنځی: ولایت . . . . . . . . . . . . . . . . . . . . ولسوالي / ناحیه . . . . . . . . . .
                        . . . . . . . . . کلی / کوڅه . . . . . . . . . . . . . . . . . کور نمبر . . . . . . . . . .
                    </div>
                    <div class="mb-1">
                ...
                <div class="col-12 mt-2 py-2" style="width: 100%">
                    <div>
                        <div class="text-center">
                            <strong>د اړوند جامعې لخوا د {{ $frm->grade->localized_name }} دورې د سند تائید</strong>
                            <p>
                                زه . . . . . . . . . . . . . . د . . . . . . . . . . . . . .  زوی د . . . . . . . . . . . . . .  ولایت د . . . . . . . . . . . . . .  ولسوالۍ د تذکرې نمبر . . . . . . . . . . . . . .  د جامعې مهتمم په حیث دنده لرم. د پورته شهرت لرونکي طالب العلم پوره تصدیق کوم، چې نوموړی له {{ $frm->grade->localized_name }} دورې په یاده جامعه کې د فراغت سند ترلاسه کړی. د جعل په صورت کې د اسلامي امارت ټولو اصولي او قانوني اجراآتو ته ژمن یم، نو په همدې اساس هیله ده چې . . . . . . . . . . . . . .  د . . . . . . . . . . . . . .  زوی ستاسې د اسنادو د برابرې او ارزونې د پروسې مستحق وګڼل شي.
                            </p>
                            <p>
                                په درنښت !
                            </p>
