    ...
    <x-page-container>
        <div class="container">
            ...
            <div class="row" style="display: none" id="form-generate-container">
                <form action="{{ route('admin.forms.commission.store') }}" class="row" method="POST">
                    ...
                    <x-select2 id="grade_id" name="grade_id" :list="JamiaHelper::grades()" text="name" value="id" :label="__('jamiat.grade_name')" col="col-sm-4" />
