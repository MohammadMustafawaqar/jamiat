    ...
    <x-page-container>
                ...
                <form action="{{ route('schools.store') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" id='country_container' style="display: none">
                            <x-select col="col-12" class="select2" :options="App\Models\Country::get()" name="country_id" id='country_id'
                                name="country_id" :label="__('lang.country')" :required="1" />
                        </div>
                        ...
                        <x-select :options="old('province_id')
                            ...
                            : collect()" col="col-6" id='district_id' name="district_id" :label="__('lang.district')"
                            :required="1" />
                    </div>
        ...
        <x-modal id='import-modal' :title="__('jamiat.import_from_excel')" size='md'>
            <div class="container-fluid">
                <form id='import-form' action="{{ route('admin.school.import.excel') }}" class="row" method="POST"
